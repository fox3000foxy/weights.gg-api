...
const statusRoute = (statusService: StatusService) => (req: Request, res: Response) => {
...
const quotaRoute = (puppeteerService: PuppeteerService) => async (_req: Request, res: Response) => {
