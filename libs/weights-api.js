...
var WeightsApi = /** @class */ (function () {
    function WeightsApi(apiKey, endpoint) {
         ...
         * @returns Promise with search results.
         */
        this.searchAudioModels = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.callWithHealthCheck(function () {
                        return _this.apiCall("/search-voices-models", HttpMethod.GET, params).then(function (response) { return response.json(); });
                    })];
            });
        }); };
        /**
         ...
         * @returns Promise with generation results.
         */
        this.generateFromTTS = function (voiceModelName, text, pitch, male) {
            if (pitch === void 0) { pitch = 0; }
            if (male === void 0) { male = true; }
            return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.callWithHealthCheck(function () {
                            return _this.apiCall("/voice", HttpMethod.POST, { voiceModelName: voiceModelName, text: text, pitch: pitch.toString(), male: male.toString() }).then(function (response) { return response.json(); });
                        })];
                });
            });
        };
         ...
         * @returns Promise with generation results.
         */
        this.generateFromAudioURL = function (voiceModelName, audioUrl, pitch) {
            if (pitch === void 0) { pitch = 0; }
            return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.callWithHealthCheck(function () {
                            return _this.apiCall("/voice", HttpMethod.POST, { voiceModelName: voiceModelName, audioUrl: audioUrl, pitch: pitch.toString() }).then(function (response) { return response.json(); });
                        })];
                });
            });
        };
